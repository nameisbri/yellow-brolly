    ...
    <Section background="black" className="relative overflow-hidden">
      ...
      <div ref={sectionRef} className="container mx-auto px-6 md:px-8 lg:px-12 max-w-7xl relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="pmc-content bg-dark-elevated rounded-2xl p-6 md:p-10 lg:p-14 border border-dark-border relative overflow-hidden">
            {/* Decorative gradient */}
            ...
            <div className="relative z-10">
              <span className="inline-block px-3 py-1.5 text-xs sm:text-sm font-medium bg-yellow-primary text-black rounded-full mb-5">
                {pmcSection.subhead}
              </span>
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-display font-bold text-white mb-6 relative">
                {pmcSection.headline}
              </h2>
              <p className="text-base md:text-lg lg:text-xl text-gray leading-relaxed relative">
