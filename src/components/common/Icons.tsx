...
export function CultureIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ClarityIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PurposeIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
