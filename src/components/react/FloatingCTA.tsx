  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40 flex flex-col items-end gap-3 animate-float-in">
      <div className="relative">
        ...
        <a
          href="/contact"
          className="group relative bg-white backdrop-blur-xl border border-yellow-primary/30 rounded-xl p-4 shadow-2xl shadow-yellow-primary/20 hover:shadow-yellow-primary/40 hover:scale-105 transition-all duration-300 flex items-center gap-4 max-w-[280px] sm:max-w-xs"
        >
