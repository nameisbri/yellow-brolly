    ...
    pillars: [
      ...
      },
      {
        ...
        whatWeDo: [
          ...
          'Cultural playbooks for tool adoption',
      ...
      },
      {
        title: 'AI – Your Way',
        description:
          'We recommend what you need, not what\'s trendy. Sometimes that\'s a spreadsheet, not AI. But when AI makes sense, we help you integrate it thoughtfully.',
        whatWeDo: [
          'AI readiness assessment',
          'Workflow automation design',
          'AI tool integration',
          'Tool stack audits for AI opportunities',
